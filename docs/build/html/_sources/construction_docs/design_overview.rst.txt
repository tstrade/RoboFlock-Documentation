...
Detailed geometry, fasteners, and CAD files for every part live in the :doc:`Parts Catalog <parts_catalog>` and the per-subsystem pages linked below.
...
.. seealso::
   ...
   :doc:`subsystems/hull_and_enclosures`
      Hull, top cover, battery compartment, sensor mounts

   :doc:`fabrication_guide` 
      Step-by-step assembly order

   :doc:`parts_catalog` 
      Every part with files and BOM

   :doc:`hardware_catalog` 
      Fasteners, inserts, bearings