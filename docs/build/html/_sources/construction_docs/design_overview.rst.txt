...
#. **Drive corners (×4)** - each wheel is driven by a BLDC motor. The motor
   ...
   bolts to a 3D-printed adapter, which carries a 10″ pneumatic wheel.
...
#. **Side suspension pivots (×2)** - a printed bracket clamps onto each
   ...
   halves and acts as the through-shaft bearing surface. This lets each side
   pivot independently.
...
#. **Battery compartment** - bolted to the underside of the main frame,
   housing the 2 3S LiPo batteries, and a 24V dedicated battery for the drivetrain.

#. **Hull and top cover** - the main hull bolts to the top of the main frame
   and houses the Jetson Orin Nano, motor drivers and other electronics. Motor leads route up
