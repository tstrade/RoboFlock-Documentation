...
1. Tracking Technology
    ...
    * RoboFlock will utilize Global Positioning System (GPS) data from both the robot and the beacon to calculate the distance and direction the robot needs to travel to reach the beacon.
...
5. Beacon Communication
    * Using Meshtastic devices, we create a line of communication over a mesh network.  This allows us to request beacon holders to return robots to the base, to communicate vital system information such as low battery levels or stuck robots, or simply send text messages to the beacon.
