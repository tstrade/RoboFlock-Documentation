...
See ``RV1-CHS-FRM-001`` in the :doc:`../parts_catalog` for sourcing and exact
length.
...
- :doc:`drivetrain` — what bolts to the inner rails of the extrusions
- :doc:`suspension` — what hangs from the ears of the main frame
- :doc:`../parts_catalog` — files and BOM for every part referenced here