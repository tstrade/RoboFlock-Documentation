...
.. @todo: Each assembly has its own subsystem page; every part across all assemblies is catalogued (with files, hardware BOM, and sourcing) in the :doc:`parts_catalog`.
...
.. @todo: subsystems/hull_and_enclosures
.. @todo: fabrication_guide
.. @todo: parts_catalog
.. @todo: hardware_catalog
